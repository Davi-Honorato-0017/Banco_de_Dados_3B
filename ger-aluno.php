  ...
  <main class="container" style="margin-top: 80px;">
    ...
    <fieldset class="border p-3 mb-3">
      ...
      <div class="row">
        ...
        <div class="col-2 ">
          ...
          <div class="col-auto">
            <input type="password" id="confirmar_senha" class="form-control" aria-describedby="passwordHelpInline">
          </div>
        </div>
      </div>
    </fieldset>
    <fieldset class="border p-3 mb-3">
      ...
      <div class="mt-3">
        ...
        <button type="submit" class="btn btn-success" name="btnGravar" id="btnGravar">Salvar</button>
      </div>
      </form>
      </div>
    </fieldset>
