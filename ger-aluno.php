      ...
      <form action="db-aluno.php" method="post" class="row p-4 g3 mt-3">
        ...
        <div class="col-md-2 mb-3 ">
          ...
          <select name="sexo" id="sexo" class="form-select">
            ...
            <option value="<?= $grupo ?>" 
            <?php if($grupo == $sexo_sel) echo 'selected' ?>
            >
              <?= $grupo ?>
            </option>
            <?php endforeach; ?>
        ...
        <div class="col-2">
            ...
            <input type="date" name="dataNascimento" id="dataNascimento" class="form-control" value="<?= $aluno->data_nascimento ?? null; ?>">
        </div>
        <div class="col-2">
        ...
        <div class="col-md-6">
          ...
          <?php
             $grupo_sel = $aluno->grupo_muscular ?? null;
          ?>
